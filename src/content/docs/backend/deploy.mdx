...
For configuration, check out the [configuration reference](/smov-docs/backend/configuration).

## Method 1 - Docker Deployment

This method provides a straightforward setup with minimal configuration. For more extensive customization, see the [Configuration Reference](/smov-docs/backend/configuration).
...
7. Congratulations! You have deployed the backend, you can now [set up the
   client](/smov-docs/self-hosting/use-backend).
</Steps>
