...
For configuration, check out the [configuration reference](/mov-docs/backend/configuration).

## Method 1 - Docker Deployment

This method provides a straightforward setup with minimal configuration. For more extensive customization, see the [Configuration Reference](/mov-docs/backend/configuration).
...
7. Congratulations! You have deployed the backend, you can now [set up the
   client](/mov-docs/self-hosting/use-backend).
</Steps>
