...
to ask in our [Discord server](/smov-docs/links/discord).
:::
...
1. [Set up the Proxy!](/smov-docs/proxy/introduction)
2. [Set up the Client!](/smov-docs/client/introduction)
...
1. [Set up the Backend!](/smov-docs/backend/introduction)
2. [Configure the Client!](/smov-docs/client/introduction)
...
1. [Set up the Proxy!](/smov-docs/proxy/introduction)
2. [Set up the Backend!](/smov-docs/backend/introduction)
3. [Set up the Client!](/smov-docs/client/introduction)
