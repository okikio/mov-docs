...
to ask in our [Discord server](/mov-docs/links/discord).
:::
...
1. [Set up the Proxy!](/mov-docs/proxy/introduction)
2. [Set up the Client!](/mov-docs/client/introduction)
...
1. [Set up the Backend!](/mov-docs/backend/introduction)
2. [Configure the Client!](/mov-docs/client/introduction)
...
1. [Set up the Proxy!](/mov-docs/proxy/introduction)
2. [Set up the Backend!](/mov-docs/backend/introduction)
3. [Set up the Client!](/mov-docs/client/introduction)
